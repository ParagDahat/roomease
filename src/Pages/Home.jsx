...
import carsoul1 from "../assets/RoomEase4.mp4";
    ...
    <div>
      ...
      >
        <div className="relative h-full  overflow-hidden">
          ...
          >
            <video
              src={carsoul1}
              className="w-full h-full object-top hidden sm:block"
              alt="..."
              autoPlay
              loop
              muted
      ...
      <div class="grid mb-8 border border-gray-200 rounded-lg shadow-sm md:mb-12 md:grid-cols-2 bg-white ">
        <figure className="flex flex-col items-center justify-center p-4 text-center bg-white border-b border-gray-200 rounded-t-lg md:rounded-t-none md:rounded-ss-lg md:border-e">
          <blockquote className="max-w-2xl mx-auto mb-4 text-gray-500 lg:mb-8 dark:text-gray-400">
            <h3 className="text-lg font-semibold text-gray-900">
              RoomEase is a game-changer!
            </h3>
            <p className="my-4">
              RoomEase offers a wide range of accommodation options,
        ...
        <figure className="flex flex-col items-center justify-center p-4 text-center bg-white border-b border-gray-200 rounded-t-lg md:rounded-t-none md:rounded-ss-lg md:border-e">
          <blockquote className="max-w-2xl mx-auto mb-4 text-gray-500 lg:mb-8 dark:text-gray-400">
            <h3 className="text-lg font-semibold text-gray-900">
              RoomEase made my search for accommodation a breeze!
            </h3>
            <p className="my-4">
              RoomEase's wide array of options, user-friendly interface, secure
