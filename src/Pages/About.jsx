      ...
      <div className="">
        ...
        {/* <div className="w-[80%] m-auto mt-7">
          <p className="text-center ">
            RoomEase is a revolutionary platform designed to simplify the
            ...
            your own, RoomEase is your trusted partner in finding the ideal
            place to call home. Experience unmatched convenience and peace of
            mind with RoomEase as you embark on your new journey.
          </p>
        </div> */}
        ...
        <div className="md:w-[1000px] m-auto mt-4">
          <ul className="ml-5 md:mt-5">
            <li>
              ...
              RoomEase offers a diverse selection of accommodation options,
              ...
              RoomEase has you covered.
            </li>
            <li className="mt-2">
              <b className="text-2xl ">&#x2022; User-Friendly Platform:</b>{" "}
              RoomEase's platform is designed with the user in mind, making it
              ...
              convenient. RoomEase's platform is accessible on both desktop and
              mobile devices, allowing you to search for accommodations anytime,
              anywhere.
            </li>
            <li className="mt-2">
              <b className="text-2xl">&#x2022; Safe and Secure Transactions:</b>{" "}
              RoomEase prioritizes your safety and security when it comes to
              ...
              booking process. RoomEase ensures that your personal and
              financial information is protected at all times.
            </li>
            <li className="mt-2">
              <b className="text-2xl">&#x2022; Dedicated Customer Support:</b>{" "}
              RoomEase provides dedicated customer support to assist you with
